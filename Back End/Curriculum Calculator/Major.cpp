...
Major::Major(int dep, int uni, std::vector<long> req, std::vector<std::vector<long>> choice, std::vector<std::vector<long>> shit, std::vector<std::vector<long>> optionz, int deg, int foc, int reqC)
{
  department = dep;
  university = uni;
  reqCourses = req;
